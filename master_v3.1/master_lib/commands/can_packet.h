...
typedef enum {
	...
	CAN_CMD_DRILL_C_BRIDGE_SET =     0x42,

    CAN_CMD_DRILL_GET_WEIGHT =       0x43,
    CAN_CMD_DRILL_SEND_WEIGHT =      0x44,
    ...
    CAN_CMD_UNIVERSAL_SET_DIGITAL_OUTPUT = 0x63,
    CAN_CMD_UNIVERSAL_SET_PWM_OUTPUT = 0x64,
    CAN_CMD_UNIVERSAL_SET_LED_DRIVER = 0x65,
    CAN_CMD_UNIVERSAL_SET_HBRIDGE = 0x66,
    CAN_CMD_UNIVERSAL_SET_STEPPER_POSITION = 0x67,
    CAN_CMD_UNIVERSAL_STEPPER_HOMING_REQUEST = 0x68,
    CAN_CMD_UNIVERSAL_WEIGHT_REQUEST = 0x69,
    CAN_CMD_UNIVERSAL_INPUT_REQUEST = 0x6A,
    CAN_CMD_UNIVERSAL_STEPPER_POSITION_REQUEST  = 0x6B,
    CAN_CMD_UNIVERSAL_WEIGHT_RESPONSE = 0x6C,
    CAN_CMD_UNIVERSAL_INPUT_RESPONSE = 0x6D,
    CAN_CMD_UNIVERSAL_STEPPER_POSITION_RESPONSE = 0x6E,
...
typedef enum {
    ...
    CAN_ARG_UNIVERSAL_SET_LED_DRIVER = 3,
