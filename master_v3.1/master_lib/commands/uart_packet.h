...
typedef enum {
    ...
    UART_CMD_UNIVERSAL_SET_DIGITAL_OUTPUT = 0x63,
    UART_CMD_UNIVERSAL_SET_PWM_OUTPUT = 0x64,
    UART_CMD_UNIVERSAL_SET_LED_DRIVER = 0x65,
    UART_CMD_UNIVERSAL_SET_HBRIDGE = 0x66,
    UART_CMD_UNIVERSAL_SET_STEPPER_POSITION = 0x67,
    UART_CMD_UNIVERSAL_STEPPER_HOMING_REQUEST = 0x68,
    UART_CMD_UNIVERSAL_WEIGHT_REQUEST = 0x69,
    UART_CMD_UNIVERSAL_INPUT_REQUEST = 0x6A,
    UART_CMD_UNIVERSAL_STEPPER_POSITION_REQUEST  = 0x6B,
    UART_CMD_UNIVERSAL_WEIGHT_RESPONSE = 0x6C,
    UART_CMD_UNIVERSAL_INPUT_RESPONSE = 0x6D,
    UART_CMD_UNIVERSAL_STEPPER_POSITION_RESPONSE = 0x6E,
...
typedef enum {
    ...
    UART_ARG_UNIVERSAL_SET_LED_DRIVER = 3,
