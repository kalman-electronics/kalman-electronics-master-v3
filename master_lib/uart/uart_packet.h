...
typedef enum {
	...
	LINK_WIFI_UART = 1 << WIFI_UART_ID,
	LINK_UART_ANY = LINK_RF_UART | LINK_AUTO_UART | LINK_DEBUG_UART | LINK_RS422_UART | LINK_WIFI_UART,
} uart_packet_link_t;
...
typedef enum {
	...
	// Power Distribution
	UART_CMD_SENSOR_RESPONSE = 0x2E,
	UART_CMD_VOLTAGE_RESPONSE = 0x2F,
	...
	UART_CMD_MOTOR_REMOTE_ESTOP = 0x43,
	UART_CMD_MOTOR_GET_REMOTE_ESTOP = 0x44,

	// Drill
	UART_CMD_DRILL_RACK_SET = 0xD0,
	UART_CMD_DRILL_SPINDLE_SET = 0xD1,
	UART_CMD_DRILL_SERVO_SET = 0xD2,
	UART_CMD_DRILL_WEIGHT_REQUEST = 0xD3,
	UART_CMD_DRILL_WEIGHT_RESPONSE = 0xD4,
	UART_CMD_DRILL_AUTONOMY = 0xD5,
	UART_CMD_DRILL_TELEMETRY = 0xD6,
	...
	UART_CMD_UNIVERSAL_SET_DISTANCE_MEASUREMENT = 0x56,
	...
	UART_CMD_UNIVERSAL_DISTANCE_RESPONSE = 0x5A,
	...
	//2DOF Camera
	UART_CMD_2DOF_CAMERA_SET_POS = 0xBF,
...
typedef enum {
	...
	UART_ARG_SENSOR_RESPONSE = 8,
	UART_ARG_VOLTAGE_RESPONSE = 2,
	...
	UART_ARG_MOTOR_REMOTE_ESTOP = 1,
	UART_ARG_MOTOR_GET_REMOTE_ESTOP = 1,

	// Drill
	UART_ARG_DRILL_RACK_SET = 1,
	UART_ARG_DRILL_SPINDLE_SET = 1,
	UART_ARG_DRILL_SERVO_SET = 3,
	UART_ARG_DRILL_WEIGHT_REQUEST = 1,
	UART_ARG_DRILL_WEIGHT_RESPONSE = 2,
	UART_ARG_DRILL_AUTONOMY = 1,
	UART_ARG_DRILL_TELEMETRY = 8,
	...
	UART_ARG_UNIVERSAL_SET_DISTANCE_MEASUREMENT = 2,
	...
	UART_ARG_UNIVERSAL_DISTANCE_RESPONSE = 4,
	...
	//
	UART_ARG_2DOF_CAMERA_SET_POS = 2,
