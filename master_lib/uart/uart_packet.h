...
typedef enum {
	...
	// Drill
	UART_CMD_DRILL_A_BRIDGE_SET = 0xD0,
	UART_CMD_DRILL_B_BRIDGE_SET = 0xD1,
	UART_CMD_DRILL_C_BRIDGE_SET = 0xD2,
	UART_CMD_DRILL_GET_WEIGHT = 0xD3,
	UART_CMD_DRILL_SEND_WEIGHT = 0xD4,
