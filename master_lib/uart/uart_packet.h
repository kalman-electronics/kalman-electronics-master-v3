...
typedef enum {
	...
	// UEUOS v2
	UART_CMD_UEUOS_SET_STATE = 0x60,
	UART_CMD_UEUOS_SET_COLOR = 0x61,
	UART_CMD_UEUOS_SET_EFFECT = 0x62,

	// Universal Module
	UART_CMD_UNIVERSAL_SET_BRIDGE = 0x70,
	UART_CMD_UNIVERSAL_SET_SERVO = 0x71,
	UART_CMD_UNIVERSAL_SET_PWM = 0x72,
	UART_CMD_UNIVERSAL_SET_GPIO = 0x73,
	UART_CMD_UNIVERSAL_GET_WEIGHT_REQUEST = 0x74,
	UART_CMD_UNIVERSAL_GET_WEIGHT = 0x8F,
