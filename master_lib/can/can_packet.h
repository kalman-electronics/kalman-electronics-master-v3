...
typedef enum {
	...
	CAN_CMD_DRILL_RACK_SET = 0xD0,
	CAN_CMD_DRILL_SPINDLE_SET = 0xD1,
	CAN_CMD_DRILL_C_BRIDGE_SET = 0xD2,
	CAN_CMD_DRILL_GET_WEIGHT = 0xD3,
	CAN_CMD_DRILL_WEIGHT_RESPONSE = 0xD4,
	CAN_CMD_DRILL_AUTONOMY = 0xD5,
	CAN_CMD_DRILL_TELEMETRY = 0xD6,

	CAN_CMD_SENSOR_RESPONSE = 0x2E,
	CAN_CMD_VOLTAGE_RESPONSE = 0x2F,
	...
	CAN_CMD_UNIVERSAL_DISTANCE_REQUEST = 0x56,
	...
	CAN_CMD_UNIVERSAL_DISTANCE_RESPONSE = 0x5A,
...
typedef enum {
	...
	CAN_ARG_DRILL_RACK_SET = 1,
	CAN_ARG_DRILL_SPINDLE_SET = 1,
	CAN_ARG_DRILL_C_BRIDGE_SET = 3,
	CAN_ARG_DRILL_SET_GEAR = 1,
	CAN_ARG_DRILL_SEND_WEIGHT = 4,
	CAN_ARG_DRILL_AUTONOMY = 1,
	CAN_ARG_DRILL_TELEMETRY = 8,
	CAN_ARG_DRILL_WEIGHT_RESPONSE = 2,

	CAN_ARG_SENSOR_RESPONSE = 8,
	CAN_ARG_VOLTAGE_RESPONSE = 4,
	...
	CAN_ARG_UNIVERSAL_DISTANCE_RESPONSE = 4,
	CAN_ARG_UNIVERSAL_DISTANCE_REQUEST = 2,
